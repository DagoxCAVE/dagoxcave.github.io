+++
title = "What I will/won't do..."
summary = "What I will and won't do"
date = "0001-01-01" # Pagination ordering weight XD
...
<p>Some certain subjects might not be displayed here. If you're unsure about certain details, you can ask me directly. If I'll find it neccessery, I'll expand the lists.</p>
...
<ul>
    ...
    <li><b>Any species</b>
        <ul>
            <li>Unless it's in "Won't do" category</li>
            <li>Personal preferences are: <b>Dargons</b>, <b>Sharks</b>, <b>Demons</b>. Some ancient/mythical creatures and monsters are cool too.</li>
        </ul>
    </li>
    <li><b>Athletic/Buff/Muscular body types</b>
        <ul>
            <li>Something like offseason bodybuilder and musclegut might work too.</li>
        </ul>
    </li>
    <li><b>Any variety of dicks</b>
        <ul>
            <li>I didn't really have experience drawing most of those, that peole can imagine, but it's still will be possible</li>
        </ul>
    </li>
    ...
    <li><b>Additional limbs and traits</b>
        <ul>
            <li>Second pair of arms / wings or multiple heads / tails / dicks / etc are possible too</li>
        </ul>
    </li>
    <li><b>Hyper</b>
        <ul>
    ...
    <li><b>Goo / Simbiote</b>
        <ul>
            <li>Did such things in the past. My preferences has shifter from that time, but I still don't mind it</li>
        </ul>
    </li>
    <li><b>Female</b>
        <ul>
