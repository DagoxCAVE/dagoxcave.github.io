...
summary = "What rights each sides have, and how the commissioned images can be used"
date = "0001-01-02" # Pagination ordering weight XD
...
<ul>
    ...
    <li>If you transfer the usage rights to another person, this usage right will be applied to that person as well
        <ul>
            <li>You are obligated to inform that person about this usage rights</li>
        </ul>
    </li>
</ul>

## How I (Dagox) may use the commissioned images
<ul>
    <li>I can post it online on any of my accounts</li>
...
## Notes
<ul>
    <li>I'm not resposible for how you will use the artwork and where you will post it</li>
    <li>I'm not obligated to delete/alter my artwork or alter the description and/or links we've agreed after the commission is done and you have made the payment</li>
    <li>My artwork is <b style="color: #e63946">NOT</b> for NFT usage, AI training and AI Img2Img image generation</li>
</ul>
